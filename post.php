			...
			<div class="row">
				<div class="col-md-6 col-lg-8">
					...
					<?php
						if($rs->url){
					?>
							<iframe style="width:100%;height:auto;" src="<?php echo $rs->url;?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					<?php
						}else{
